...
class BlacklistEmbed(discord.Embed):
    def __init__(self):
        ...
        self.add_field(
            name="Reason",
            value="Please contact support [here](https://discord.gg/rkRrRfRTwg) for more details.",
        )
...
class SetupEmbeds:
    ...
    def get_module_selection_embed(self):
        ...
        embed.set_footer(
            text="You can enable or disable modules later via the settings menu."
        )
        return embed
...
class ReminderListEmbed:
    ...
    def create_embed(self):
        embed = discord.Embed(
            title="Your Reminders", color=constants.strive_embed_color_setup()
        )
    ...
    def create(self):
        ...
        embed = discord.Embed(
            ...
            color=(
                ...
                else self.constants.strive_embed_color_setup()
            ),
            timestamp=datetime.utcnow(),
        )
