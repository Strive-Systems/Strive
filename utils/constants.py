...
class StriveConstants:
    ...
    def strive_client_id_setup(self):
    ...
    def strive_client_secret_setup(self):
    ...
    def strive_redirect_uri_setup(self):
    ...
    def strive_embed_color_setup(self):
    ...
    def strive_environment_type(self):
