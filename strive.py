    ...
    async def on_ready(self):
        ...
        if constants.strive_environment_type() == "Development":
            for guild in strive.guilds:
                ...
                channel = strive.get_guild(self.beta_guilds[0]).get_channel(1338806026094247968)
        ...
        print(f"{strive.user.name} is ready!")#with {guild_count} guilds and {user_count:,} users.
...
strive = Strive(command_prefix=get_prefix,
            intents=intents,
