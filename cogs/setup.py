    ...
    async def setup(self, ctx: commands.Context):
        try:
            ...
            await ctx.send(embed=ErrorEmbed(
                title="",
                description=f"<:strivefail:1338900416972193902> An error occurred during setup: {e}."
            ))
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    if not re.fullmatch(r"#[0-9a-fA-F]{6}", self.embed_color.value):
                        await interaction.followup.send("<:strivefail:1338900416972193902> Invalid color format. Please use #RRGGBB format.", ephemeral=True)
                        return
                    ...
                    try:
                        ...
                        await interaction.followup.send("<:strivefail:1338900416972193902> I do not have permission to change the bot's nickname.", ephemeral=True)
                        return
    ...
    async def run_module_selection(self, ctx, message):
        ...
        async def done_callback(interaction: discord.Interaction):
            if not self.selected_modules:
                await interaction.response.send_message("<:strivefail:1338900416972193902> Please select at least one module!", ephemeral=True)
                return
        ...
        class LoggingSetupModal(discord.ui.Modal, title="Logging Setup"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message("<:strivesuccess:1338900384932036618> Logging system configured successfully!", ephemeral=True)
                except ValueError:
                    await interaction.response.send_message("<:strivefail:1338900416972193902> Please enter a valid channel ID.", ephemeral=True)
        ...
        class WelcomeSetupModal(discord.ui.Modal, title="Welcome System Setup"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message("<:strivesuccess:1338900384932036618> Welcome system configured successfully!", ephemeral=True)
                except ValueError:
                    await interaction.response.send_message("<:strivefail:1338900416972193902> Please enter a valid channel ID.", ephemeral=True)
        ...
        class TicketSetupModal(discord.ui.Modal, title="Ticket System Setup"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message("<:strivesuccess:1338900384932036618> Ticket system configured successfully!", ephemeral=True)
                except ValueError:
                    await interaction.response.send_message("<:strivefail:1338900416972193902> Please enter valid numeric IDs.", ephemeral=True)
        ...
        class ModerationSetupModal(discord.ui.Modal, title="Moderation Setup"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message("<:strivesuccess:1338900384932036618> Moderation system configured successfully!", ephemeral=True)
                except ValueError:
                    await interaction.response.send_message("<:strivefail:1338900416972193902> Please enter valid numeric IDs.", ephemeral=True)
        ...
        class SuggestionSetupModal(discord.ui.Modal, title="Suggestion System Setup"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message("<:strivesuccess:1338900384932036618> Suggestion system configured successfully!", ephemeral=True)
                except ValueError:
                    await interaction.response.send_message("<:strivefail:1338900416972193902> Please enter a valid channel ID.", ephemeral=True)
